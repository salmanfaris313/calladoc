...
export default function Home() {
  return (
    <>
      <Hero
        title="Primary Care Just One Touch! </br> Human Care </br> Digital Touch."
        subTitle="Call Our Doctor for a Virtual Consultation No Waiting, Easy Access, and Affordable Rates!"
