...
const departmentData = [
  {
    ...
    listitems: [
      "General medical consultations (General/ Family Medicine) ",
      "Acute illness management",
      "Preventive care and wellness checks-ups",
    ],
  ...
  },
  {
    ...
    listitems: [
      "Ongoing care for conditions such as diabetes, hypertension, and asthma",
  ...
  },
  {
    ...
    listitems: [
      "Any prescription that needs to be refilled every frequent ",
  ...
  },
  {
    ...
    listitems: [
      "Access to a network of medical specialists for advanced care",
  ...
  },
  {
    ...
    listitems: [
      "Regular follow-up consultations to monitor health progress",
...
const faqData = [
  ...
  {
    title:
      "What types of medical issues can be addressed in a telehealth consultation?",
    content:
